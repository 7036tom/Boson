...
#input_shape=(28,1)
model = [Sequential(), Sequential(),Sequential(), Sequential(), Sequential(), Sequential(), Sequential(),Sequential(), Sequential(), Sequential(), Sequential(), Sequential(),Sequential(), Sequential(), Sequential(),Sequential(), Sequential(),Sequential(), Sequential(), Sequential()]
...
for i in range(1):
	for train, test in kfold.split(X2, Y2):
		...
		# Fit the model		
		model[j].fit(X2[train], Y3[train],validation_data=(X2[test], Y3[test]), nb_epoch=200, batch_size=93, class_weight=class_weight, shuffle=True, verbose=1, callbacks=callbacks)#, class_weight=class_weight)
		...
		print("AMS : " +str(AMS/len(test) * 250000))
		"""
...
Result_local = merged_model.predict([X2, X2, X2, X2, X2, X2, X2, X2, X2, X2, X2, X2, X2, X2, X2, X2, X2, X2, X2, X2], batch_size=32, verbose=0)
...
Result_test = merged_model.predict([Z2, Z2, Z2, Z2, Z2, Z2, Z2, Z2, Z2, Z2, Z2, Z2, Z2, Z2, Z2, Z2, Z2, Z2, Z2, Z2], batch_size=32, verbose=0)
